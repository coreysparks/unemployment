...
lfpartreg%>%
 # filter(is.na(differnce)==F,  yr_month!=('2020-01-01'))%>%
  ...
  geom_hline(yintercept = 0, lwd=.7,lty=2)+
  labs(title = "Job Gains and Losses by Gender",subtitle = "February 2020 to June 2021",
       caption = "Source: IPUMS CPS Monthly Data",
       x = "Month",
       y = "% Jobs Recovered")+
  theme_minimal()+
...
lfpartreg%>%
 # filter(is.na(differnce)==F,  yr_month!=('2020-01-01'))%>%
  ...
  #geom_hline(yintercept = 0, lwd=.7,lty=2)+
  facet_wrap(~sex)+
  labs(title = "Change in Number of Workers by Nativity and Gender among Latinos",subtitle = "February 2020 to June 2021",
       caption = "Source: IPUMS CPS Monthly Data",
       x = "Month",
       y = "% Jobs Recovered")+
  theme_minimal()+
