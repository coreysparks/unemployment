...
out_remote%>%
  ...
  labs(title = "Remote Work by Race/Ethnicity",subtitle = "May 2020 to April 2021",
...
ggsave("~/OneDrive - University of Texas at San Antonio/projects/carsey_brief/rwraceeth.png",height=8, width=10, dpi = "print")
#rm(out_remout) 
```
...
out_gender%>%
  filter(race_eth2!="NHPI.Not Latino", race_eth2!="AIAE.Not Latino",race_eth2!="multiple.Not Latino", remoterate!=0, race_eth2!="Asian.Not Latino")%>%
  ggplot()+geom_line(aes(x=month, y=remoterate,color=race_eth2, group=race_eth2), lwd=2)+
  labs(title = "Remote Work by Race/Ethnicity and Gender",subtitle = "May 2020 to April 2021",
       caption = "Source: IPUMS CPS Monthly Data",
       x = "Month",
...
ggsave("~/OneDrive - University of Texas at San Antonio/projects/carsey_brief/rwregender.png",height=8, width=10, dpi = "print")
```
...
out_foreign%>%
  ...
  filter(race_eth2!="NHPI.Not Latino", race_eth2!="AIAE.Not Latino",race_eth2!="multiple.Not Latino", remoterate!=0, race_eth2!="Asian.Not Latino")%>%
  ggplot()+geom_line(aes(x=month, y=remoterate,color=race_eth2, group=race_eth2), lwd=2)+
  labs(title = "Remote work by Race/Ethnicity, Gender and Nativity Status",subtitle = "May 2020 to April 2021",
       caption = "Source: IPUMS CPS Monthly Data",
       x = "Month",
       y = "Percent working remotely")+ylim(c(0, .25))+
 ...
 ggsave("~/OneDrive - University of Texas at San Antonio/projects/carsey_brief/rwfb.png",height=8, width=10, dpi = "print")
```
...
out_educ<-cpsdat%>%
 ...
 out_educ%>%
   ...
   labs(title = "Remote work by Race/Ethnicity and Education",subtitle = "May 2020 to April  2021",
        caption = "Source: IPUMS CPS Monthly Data ",
        x = "Month",
   ...
   scale_y_continuous(labels = scales::percent)+
   theme_minimal()+theme(axis.text.x = element_text(angle = 45))
ggsave("~/OneDrive - University of Texas at San Antonio/projects/carsey_brief/rweduc.png",height=8, width=10, dpi = "print")
```
