...
outna%>%
 filter(race_eth2!="NHPI.Not Latino", race_eth2!="AIAE.Not Latino",race_eth2!="multiple.Not Latino", emprate!=0, race_eth2!="Asian.Not Latino")%>%
  ...
  labs(title = "Percent Unemployed by Race/Ethnicity",subtitle = "February 2020 to April 2021",
...
outna2%>%
  ...
  ggplot()+geom_line(aes(x=month, y=emprate,color=race_eth2, group=race_eth2), lwd=2)+
  #scale_fill_discrete(name=)+
  labs(title = "Percent Unemployed by Race/Ethnicity and Gender",subtitle = "February 2020 to April 2021",
       caption = "Source: IPUMS CPS Monthly Data \n Calculations by Corey S. Sparks, Ph.D.",
       x = "Month",
       y = "Percent Unemployed")+ylim(c(0, .25))+
  scale_color_carsey(  name = "Race/Ethnicity",labels=c(" Black", "Latino"," White"))+facet_wrap(~sex)+scale_y_continuous(labels = scales::percent)+
  #guides(fill=guide_legend(title="Race/Ethnicity"))+
  #geom_hline(yintercept = 0, col="red", lwd=1.1)+
theme_minimal()+theme(axis.text.x = element_text(angle = 45))
...
outna2%>%
  ...
  scale_color_carsey( name = "Race/Ethnicity",labels=c(" Black", "Latino"," White"))+facet_wrap(~educ+sex, ncol = 4)+scale_y_continuous(labels = scales::percent)+
  #guides(fill=guide_legend(title="Race/Ethnicity"))+
  #geom_hline(yintercept = 0, col="red", lwd=1.1)+
theme_minimal()+theme(axis.text.x = element_text(angle = 45))
...
outna2%>%
  ...
  ggplot()+geom_line(aes(x=month, y=emprate,color=race_eth2, group=race_eth2), lwd=2)+
  #scale_fill_discrete(name=)+
  labs(title = "Percent Unemployed by Race/Ethnicity and Nativity Status",subtitle = "February 2020 to April 2021",
       caption = "Source: IPUMS CPS Monthly Data \n Calculations by Corey S. Sparks, Ph.D.",
       x = "Month",
       y = "Percent Unemployed")+ylim(c(0, .25))+
...
#=======
ggsave(filename = "images/national_unemp_sex_fb.png",height=8, width=10, dpi = "print" )
...
p<-outst%>%
  ...
  #scale_fill_discrete(name=)+
  labs(title = "Percent Unemployed by State",subtitle = "February 2020 to April 2021",
       caption = "Source: IPUMS CPS Monthly Data \n Calculations by Corey S. Sparks, Ph.D.",
       x = "Month",
...
outst%>%filter(stname=="New Hampshire")%>%ggplot(aes(x=month, y=emprate, color=race_eth2))+geom_line(aes(group=race_eth2), lwd=1.75)+ggtitle("New Hampshire Unemployment Rates", subtitle = "February 2020 to April 2021")+geom_line(data=usavg, aes(x=month, y=emprate, group="National Rate"), col="black")+scale_y_continuous(labels = scales::percent)+
  #guides(fill=guide_legend(title="Race/Ethnicity"))+
  #geom_hline(yintercept = 0, col="red", lwd=1.1)+
theme_minimal()+theme(axis.text.x = element_text(angle = 45))
...
p<-outst%>%
  ...
  #scale_fill_discrete(name=)+
  labs(title = "Percent Unemployed by State and Race/Ethnicity",subtitle = "February to April 2021",
       caption = "Source: IPUMS CPS Monthly Data \n Calculations by Corey S. Sparks, Ph.D.",
       x = "Month",
       y = "Percent Unemployed")+
...
outna2%>%
  ...
  ggplot()+geom_line(aes(x=month, y=emprate,color=race_eth2, group=race_eth2), lwd=2)+
  #scale_fill_discrete(name=)+
  labs(title = "Percent Unemployed by Race/Ethnicity, and Age Group",subtitle = "February 2020 to April 2021",
       caption = "Source: IPUMS CPS Monthly Data \n Calculations by Corey S. Sparks, Ph.D.",
       x = "Month",
       y = "Percent Unemployed")+ylim(c(0, .4))+
  scale_color_carsey( name = "Race/Ethnicity",labels=c(" Black", "Latino"," White"))+facet_wrap(~Age_Group, ncol = 3)+scale_y_continuous(labels = scales::percent)+
  #guides(fill=guide_legend(title="Race/Ethnicity"))+
  #geom_hline(yintercept = 0, col="red", lwd=1.1)+
theme_minimal()+theme(axis.text.x = element_text(angle = 45))
...
mutate(metro = car::Recode(METRO, recodes = "1='Not Metro';2='Central City'; 3='Outside Central City'"))%>%
  ...
  #scale_fill_discrete(name=)+
  labs(title = "Percent Unemployed by Metropolitan Residence",subtitle = "February to April 2021",
       caption = "Source: IPUMS CPS Monthly Data \n Calculations by Corey S. Sparks, Ph.D.",
       x = "Month",
       y = "Percent Unemployed")+#ylim(c(0, .4))+
  scale_color_carsey( name = "Location")+scale_y_continuous(labels = scales::percent)+
  #guides(fill=guide_legend(title="Race/Ethnicity"))+
  #geom_hline(yintercept = 0, col="red", lwd=1.1)+
theme_minimal()+theme(axis.text.x = element_text(angle = 45))
...
#   ggplot()+geom_line(aes(x=month, y=emprate,color=race_eth2, group=race_eth2), lwd=2)+
#   #scale_fill_discrete(name=)+
#   labs(title = "Percent Unemployed byand Race/Ethnicity and Metropolitan Residence",subtitle = "February to April 2021",
#        caption = "Source: IPUMS CPS Monthly Data \n Calculations by Corey S. Sparks, Ph.D.",
#        x = "Month",
#        y = "Percent Unemployed")+#ylim(c(0, .4))+
...
p8b<-dat7%>%
 ...
 # mutate(diffemp = lag(Employed, n = 1))
  ...
  theme_minimal()+
  theme(axis.text.x = element_text(angle = 45))+
  labs(title = "Percent of February 2020 Jobs Recovered \nin April 2021 by Education Level",
       caption = "Source: IPUMS CPS Monthly Data \n Calculations by Rogelio Saenz, Ph.D.",
       x = "Month",
       y = "% Recovered Jobs")
