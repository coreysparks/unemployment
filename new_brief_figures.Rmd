...
lfpartreg%>%
 # filter(is.na(differnce)==F,  yr_month!=('2020-01-01'))%>%
  ...
  labs(title = "Percent Change in Number of Employed Persons from February 2020 by Gender",subtitle = "February 2020 to June 2021",
       caption = "Source: IPUMS CPS Monthly Data",
       x = "Month",
...
lfpartreg%>%
 # filter(is.na(differnce)==F,  yr_month!=('2020-01-01'))%>%
  ...
  geom_hline(yintercept = 0, lwd=.7,lty=2)+
  labs(title = "Percent Change in Number of Employed Persons from February 2020 by Race/Ethnicity",subtitle = "February 2020 to June 2021",
       caption = "Source: IPUMS CPS Monthly Data\n Calculations by Corey S. Sparks, Ph.D.",
       x = "Month",
       y = "% Change in Number of Employed Persons")+
  #facet_wrap(~sex)+
...
lfpartreg%>%
 # filter(is.na(differnce)==F,  yr_month!=('2020-01-01'))%>%
  ...
  geom_line(aes(x=yr_month, y=pct_ch, group = race_eth2, color=factor(race_eth2)), lwd=1.15)+
 # geom_hline(yintercept = 0, lwd=.7,lty=2)+
  labs(title = "Change in Number of Employed People by Race/Ethnicity and Gender",subtitle = "February 2020 to June 2021",
       caption = "Source: IPUMS CPS Monthly Data",
       x = "Month",
       y = "% Jobs Recovered")+
  facet_wrap(~sex)+
...
lfpartreg%>%
 ...
 # filter(is.na(differnce)==F,  yr_month!=('2020-01-01'))%>%
  ...
  labs(title = "Job Gains and Losses by Gender and Education",subtitle = "February 2020 to June 2021",
       caption = "Source: IPUMS CPS Monthly Data",
       x = "Month",
       y = "% Jobs Recovered")+
  theme_minimal()+
...
lfpartreg%>%
 # filter(is.na(differnce)==F,  yr_month!=('2020-01-01'))%>%
  ...
  labs(title = "Change in Number of Employed People by Nativity and Gender among Latinos",subtitle = "February 2020 to June 2021",
       caption = "Source: IPUMS CPS Monthly Data\n Calculations by Corey S. Sparks, Ph.D.",
       x = "Month",
       y = "% Jobs Recovered")+
  theme_minimal()+
