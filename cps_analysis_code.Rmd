...
```{r, eval=FALSE}
ddi<-read_ipums_ddi("C:/Users/corey/OneDrive - University of Texas at San Antonio//cps_00026.xml")
...
#save(cpsdat,  file="~/Github/unemployment/data/analysisdata.Rdata")
#rm(cpsdat)
gc()
```

```{r, eval=FALSE}
save(cpsdat ,file =  "C:/Users/corey/github/unemployment/data/analysisdata.Rdata")
load( "C:/Users/corey/github/unemployment/data/analysisdata.Rdata")
```
